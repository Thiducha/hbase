...
public final class HConstants {
  ...
  /** Parameter name for what hbase client connections implementation to use. */
  public static final String HBASECLIENT_CONNECTION_IMPL= "hbase.hbaseclient.connection.impl";
